...
### [我的博客在这里 &rarr;](https://yusq77.github.io)
...
我的博客仓库——`yusq77.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家推荐做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方都说明了。或者可以直接下载zip到本地自己去修改。
...
* 如果你喜欢我的这个博客模板，请在`yusq77.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Yusq Blog             # 你的博客网站标题
SEOTitle: Yusq Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: yusq77     # 你的github账号
weibo_username: yusq77      # 你的微博账号，底部链接会自动更新的。
...
看右边:
![](https://github.com/yusq77/yusq77.github.io/tree/master/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-yusq.jpg     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“Yusq Blog”** 但是我想要在搜索的时候显示 **“Yusq 的博客 | Yusq Blog”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。

## 致谢

1. 这个模板是从这里[Huxpro](https://github.com/Huxpro/huxpro.github.io)  fork 的。 感谢这个作者
